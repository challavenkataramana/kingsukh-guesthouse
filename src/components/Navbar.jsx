        ...
        {isMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 h-full w-70 bg-white/95 backdrop-blur-md shadow-xl z-[70] md:hidden"
            >
                ...
                <nav className="flex-1 flex flex-col space-y-4">
                  {navItems.map((item, i) => (
                    <motion.a
                      ...
                      href={`#${item.toLowerCase()}`}
                      onClick={() => setIsMenuOpen(false)}
                      className="flex items-center justify-between font-bold text-gray-800 hover:text-black py-3 px-4 rounded-lg hover:bg-blue-200 transition-colors group"
                      custom={i}
                      initial="closed"
                      animate="open"
